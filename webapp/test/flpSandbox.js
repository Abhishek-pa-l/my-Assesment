		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "My Assesments",
									"targetURL": "#comsapmyassesments-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmyassesments-display": {
								"semanticObject": "comsapmyassesments",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.myassesments",
									"url": sap.ui.require.toUrl("com/sap/myassesments")
								}
							}
						}
					}
